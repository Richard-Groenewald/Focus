...
CREATE TABLE public.leads (
    ...
    source_person_title text,
    source_person_email text,
    source_person_phone text,
...
--
-- Addendum: Sales Campaigns (see sql/add_sales_campaigns.sql) — parallel to
-- research_campaigns. Kept here so the dump reflects the live schema.
--
...
-- leads.sales_campaign_id → sales_campaigns(id)
ALTER TABLE public.leads ADD COLUMN IF NOT EXISTS sales_campaign_id bigint;
